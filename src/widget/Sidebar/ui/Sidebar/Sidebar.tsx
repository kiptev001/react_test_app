...
const Sidebar: FC<SidebarProps> = (props) => {
  ...
  return (
    ...
    >
      <div className={cls.links}>
        ...
        >
          {collapsed
            ...
            : <div className={cls.link}><LoginIcon className={cls.homeIcon} />{t('Войти')}</div>}
        </AppLink>
        ...
        >
          {collapsed
            ...
            : <div className={cls.link}><HomeIcon className={cls.homeIcon} />{t('Главная')}</div>}
        </AppLink>
      </div>
      <MyButton
      ...
      <div className={classNames(cls.switchers, { [cls.column]: collapsed }, [])}>
        <ThemeSwitcher />
